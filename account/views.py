...
def getdata(request):
    fabrictype = request.GET['fabrictype']
    fabricname = request.GET['fabricname']
    content = request.GET['content']
    gsm = request.GET['gsm']
    yarncount = request.GET['yarncount']
    construction = request.GET['construction']
    type = request.GET['type']
#    return JsonResponse({"values":fabrictype+" "+fabricname+" "+content+" "+gsm+" "+yarncount+" "+construction+" "+type})
    if type=="":
        type = None
